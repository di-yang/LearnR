...
xgbGrid1 = expand.grid(nrounds = c(25, 50, 100, 200), #200, 300
                       max_depth = c(1, 2, 3, 4), #2, 4, 6
                       eta = c(0.01, 0.025, 0.05, 0.75),  # 0.05, 0.075
                       gamma = 0,
                       colsample_bytree = c(0.6, 0.7, 0.8, 0.9), #6, 7, 8
                       min_child_weight = 20,
...
xgbGrid2 = expand.grid(nrounds = c(100, 200, 300, 400), #200, 300
...
xgbGrid3 = expand.grid(nrounds = c(100, 200, 300, 400), #200, 300
                       max_depth = c(2, 3, 4, 6), #2, 4, 6
                       eta = c(0.01, 0.025, 0.05),  # 0.05, 0.075
                       gamma = 0,
                       colsample_bytree = c(0.8, 0.9, 1), #6, 7, 8
                       min_child_weight = 20,
