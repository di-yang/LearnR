...
YPLLanalytic=analyticnweight[-c(2,3,4,6,12,20)]
...
mentalanalytic=analyticnweight[-c(1,3,4,6,12,20)]
nc = parallel::detectCores()  
cl = makePSOCKcluster(nc-1)   # Set number of cores equal to machine number minus one
registerDoParallel(cl)        #Set up parallel
...
physicalanalytic=analyticnweight[-c(1,2,4,6,12,20)]
nc = parallel::detectCores()  
cl = makePSOCKcluster(nc-1)   # Set number of cores equal to machine number minus one
registerDoParallel(cl)        #Set up parallel
...
fairpooranalytic=analyticnweight[-c(1,2,3,6,12,20)]
nc = parallel::detectCores()  
cl = makePSOCKcluster(nc-1)   # Set number of cores equal to machine number minus one
registerDoParallel(cl)        #Set up parallel
